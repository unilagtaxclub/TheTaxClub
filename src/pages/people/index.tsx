...
const OurPeople = () => {
  const executives = [
    ...
    {
      id: 10,
      frontCard: "/assets/people-imgs/teemah-front.jpg",
      name: "Fateemah Quadri",
      title: "Welfare Secretary",
      bio: "Fateemah Quadri is a 400 level law student keen interest for law, social justice, and the community development. She currently serves as the welfare secretary of the University of Lagos Tax Club. Her hobbies include playing squash, reading, writing and spending quality time with family and friends",
    },
  ];
  ...
  const staffAdvisers = [
    ...
    {
      id: 12,
      frontCard: "/assets/people-imgs/dr-philip-front.png",
      name: "Dr Philip Folarin",
      title: "Staff Adviser",
      bio: "Dr Philip Abiodun Folarin Iis a distinguished Nigerian legal scholar and senior Lecturer at the university of Lagos, renowned for his influential research on labor rights and constitutionalism in the workplace. He earned his Ph.D from  the University of Lagos and has published extensively in prestigious national and international journals. He is an active member of the prominent legal and  taxation professional bodies in Nigeria  ",
    },
  ];
  ...
  const elders = [
    ...
    },
    {
      ...
      title: "Ex CITN President",
      bio: "Popularly known as TEJUTAX, professor Olateju Abiola Somorin is a highly esteemed academic and tax expert, recognized for her significant contributions to the Nigerian Tax System. She became the first Nigerian to earn a Master of Taxation (MITAX) degree in 1982 and later received a Doctor of letters degree in 2022.",
    },
    {
      id: 17,
  ...
  return (
    <Container>
      <div className="bg-[#f2f2f2] min-h-screen">
        <div className="bg-[url('/assets/hero-imgs/people-hero-img.png')] lg:h-[581px] bg-cover bg-no-repeat">
