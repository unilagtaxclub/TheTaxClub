...
const Hero = () => {
  return (
    <div className="bg-[url('/assets/hero.jpeg')] lg:w-[80vw] w-[90vw] mx-auto mt-10 rounded-2xl lg:min-h-[650px] bg-cover bg-no-repeat">
      <div className="bg-[rgba(0,0,0,0.4)] text-[#fff] w-[100%] flex flex-col items-center justify-center lg:min-h-[650px] rounded-2xl py-10 px-6">
